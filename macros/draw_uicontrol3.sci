// 3. CheckBox
function draw_uicontrol3(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'checkbox','tag',props(1),'string',props(2),'position',rec,'fontsize',12,'callback','auto');
