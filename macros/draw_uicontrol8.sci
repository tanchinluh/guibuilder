// 8. ListBox
function draw_uicontrol8(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'listbox','tag',props(1),'string',props(2),'position',rec,'fontsize',12,'callback','auto');
