// 11. Spinner
function draw_uicontrol11(handles)
    ...
    handles.current_handle =  uicontrol(handles.f2, 'units','normalized', 'style', 'spinner','tag',props(1),'string',props(2),'position',rec,'fontsize',12,'callback','auto');
