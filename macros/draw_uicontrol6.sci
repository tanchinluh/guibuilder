// 6. Slider
function draw_uicontrol6(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'slider','tag',props(1),'string',props(2),'position',rec,'fontsize',12,'callback','auto','enable','off');
