// 4. Edit Box 
function draw_uicontrol4(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'edit','tag',props(1),'string',props(2),'position',rec,'fontsize',12);
