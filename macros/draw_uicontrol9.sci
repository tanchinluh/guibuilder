// 9. Popup Menu
function draw_uicontrol9(handles)
    ...
    handles.current_handle =  uicontrol(handles.f2, 'units','normalized', 'style', 'popupmenu','tag',props(1),'string',props(2),'position',rec,'fontsize',12,'callback','auto');
