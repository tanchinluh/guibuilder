// 7. Frame
function draw_uicontrol7(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'frame','tag',props(1),'string',props(2),'position',rec,'fontsize',12);
