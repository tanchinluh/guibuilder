// 5. Text
function draw_uicontrol5(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'text','tag',props(1),'string',props(2),'position',rec,'fontsize',12);
