//****************************
//UIControl Creation Functions
//****************************

// 1. PushButton
function draw_uicontrol1(handles)
    ...
    handles.current_handle = uicontrol(handles.f2, 'units','normalized', 'style', 'pushbutton','tag',props(1),'string',props(2),'position',rec,'fontsize',12,'callback','auto');
